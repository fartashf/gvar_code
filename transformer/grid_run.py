...
if __name__ == '__main__':
    ...
    parser.add_argument('--grid', default='transformer', type=str)
    parser.add_argument('--run_name', default='', type=str)
    parser.add_argument('--cluster', default='vector', type=str)
    parser.add_argument('--cluster_args', default='4,4,p100,t4', type=str)
