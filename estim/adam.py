...
class AdamEstimator(GradientEstimator):
    def __init__(self, *args, **kwargs):
        ...
        self.init_data_iter()
        self.beta1, self.beta2 = self.opt.g_adam_beta1, self.opt.g_adam_beta2
        self.v = None
        self.m = None
        self.beta1_correction, self.beta2_correction = 1, 1
        self.eps = self.opt.g_adam_eps
    ...
    def get_new_mv(self, model):
        ...
        v = [beta1 * vv + (1-beta2) * gg*gg for vv, gg in zip(self.v, g)]
    ...
    def snap_online(self, model, niters):
        ...
        self.beta1_correction = 1 - self.beta1 ** max(1, niters)
        self.beta2_correction = 1 - self.beta2 ** max(1, niters)
